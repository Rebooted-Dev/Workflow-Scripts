...
8. **Meta** (`00-Meta-Workflow/00-meta/`) - Templates, rubrics, and analysis documents about these workflows
9. **Docs** (`00-Meta-Workflow/00-docs/`) - Code review reports, archived reviews, and analysis documents generated by workflows
