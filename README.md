...
The workflows are organized into fifteen categories:
...
9. **Deployment** (`07-deployment/`) - Deployment, hosting, browser automation, and port-management guides
10. **API Integration** (`08-API-Integration/`) - AI SDK, Genkit, and service-provider integration guides
11. **Technical Docs** (`10-technical-docs/`) - Focused technical reference material
12. **Reusable Skills** (`11-Skills/`) - Skill bundles retained for review; active installation is held — see `11-Skills/README.md` and `../Core-Knowledge/Tech-notes/Workflow-Scripts/11-Skills/` for the holding area
13. **SEO/GEO** (`12-SEO-GEO-checklist/`) - Search and generative-engine optimization checklists
14. **Meta** (`00-Meta-Workflow/00-meta/`) - Templates, rubrics, and analysis documents about these workflows
15. **Docs** (`00-Meta-Workflow/00-docs/`) - Code review reports, archived reviews, and analysis documents generated by workflows
...
| Reviewing and finalising a plan in one pass | Plan Review and Finalise | `01-planning-and-organizing/03-plan-review-and-finalise.md` |
| Reviewing dependencies or planning upgrades | Dependency Review | `05-review/00-dependencies.md` |
| Running a comprehensive repository audit | Comprehensive Audit | `05-review/05-comprehensive-audit.md` |
...
| Reusing repeated agent workflows | Skill Bundles | Held outside this repository for review |
...
│   ├── 08-kaparthy-template.md
│   └── 09-seo-skill-setup.md
├── 01-planning-and-organizing/
│   ├── README.md (directory index)
│   ├── 00-research-and-plan.md
│   ├── 01-plan-review.md
│   ├── 02-finalise-plan.md
│   └── 03-plan-review-and-finalise.md
├── 02-code-build/
│   ├── README.md (directory index)
│   ├── 01-execution.md
│   ├── 02-confirm-execution.md
│   ├── 03-execute-and-confirm.md
│   └── 04-review-finalise-commit-execute.md
├── 03-debugging/
│   ├── README.md (directory index)
...
│   └── Gemini/
├── 11-Skills/
│   ├── README.md (held bundles — not active for agent skill discovery)
│   └── ... (skill bundle directories retained for review)
