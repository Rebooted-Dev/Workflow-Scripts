...
## Purpose
Perform a structured analysis to identify code quality issues, technical debt, and refactoring opportunities that improve maintainability, readability, and extensibility, then file a report in `project/research/`.
...
5. Save the report to `project/research/` with a dated filename following the format: `code-refactoring-YYMMDD-HHMM-{model}.md`
