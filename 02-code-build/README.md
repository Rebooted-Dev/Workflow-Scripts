...
- **[`../04-documentation/03-mark-completed.md`](../04-documentation/03-mark-completed.md)** — task checkbox conventions (`- [✅]` vs `- [ ]`), completion markers, and how to archive completed plans.
