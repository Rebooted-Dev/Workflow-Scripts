...
| [`07-migrate-project-structure.md`](./07-migrate-project-structure.md) | Migrate an existing project to the standard `project/` directory structure | Projects with legacy changelog/troubleshooting/plans layouts |
| [`08-greenfield-mvp.md`](./08-greenfield-mvp.md) | Greenfield MVP setup (redirect stub; canonical content in rationalized `workflows/setup/` tree) | New greenfield MVP projects when the full workflow is available in the consolidated tree |
