---
date: "2026-07-03"
title: "Workflow-Scripts Deep Review — Code, Security, Optimization & Instruction Clarity"
category: "review"
...
- **Locations (all verified against the actual tree):**
  ...
  4. `00-Meta-Workflow/00-meta/glossary.md` §Workflow Categories lists **`01a-orchestrator/`, `01-planning-and-organizing/`, `workflows/build/`, `workflows/debugging/`, `workflows/review/`** — none exist; actuals are `00-Meta-Workflow/00-orchestrator/`, `01-planning-and-organizing/`, `02-code-build/`, `03-debugging/`, `05-review/`. It also omits `11-Skills/` and `12-SEO-GEO-checklist/`.
