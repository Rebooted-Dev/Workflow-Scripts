...
triggers:
  - "security review"
  - "audit security"
inputs: [repository-root, focus-areas, security-requirements]
outputs: [security-review-report]
requires: [metadata-root, parallel-agents, review-workflow-core, severity-priority-rubric, security-baseline, error-handling, observability]
agents: [security-scanner, dependency-reviewer, bug-hunter]
...
- Use primary skill `filed-code-review-to-remediation` for evidence-backed security findings and remediation handoff.
...
## Purpose
Perform a structured security review that identifies vulnerabilities, security risks, and compliance issues, then file a report in `<metadata-root>/research/` using the metadata-root rule in `../../core/meta/naming-conventions.md`.

Use the shared review contract in `../../core/meta/review-workflow-core.md` for report routing, pre-flight checks, untrusted-content handling, severity/priority scoring, evidence quality, deduplication, report outline, and acceptance criteria.
...
Follow `../../core/meta/review-workflow-core.md`; security-review-specific checks are:

Before scanning, verify:
- [ ] Repository root is identified and accessible
- [ ] Rubric file exists at `../../core/meta/severity-priority-rubric.md`
...
- **[`../review/01-code-review.md`](../review/01-code-review.md)** - General code review (includes security checks)
...
- **[`../planning/02-finalise-plan.md`](../planning/02-finalise-plan.md)** - Create implementation plan for security fixes
- **[`../../core/meta/severity-priority-rubric.md`](../../core/meta/severity-priority-rubric.md)** - Reference for severity and priority scoring
