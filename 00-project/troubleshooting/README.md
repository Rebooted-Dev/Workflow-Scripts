...
This directory contains organized troubleshooting entries for issues encountered during Workflow-Scripts development. It lives under `00-project/troubleshooting/`.
