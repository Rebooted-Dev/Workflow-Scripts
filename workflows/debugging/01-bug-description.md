...
## Prioritization Rule
- Classify the bug using severity (S0–S3) and priority (P0–P3) per the shared rubric: `../../core/meta/severity-priority-rubric.md`.
...
- **[`../../core/meta/severity-priority-rubric.md`](../../core/meta/severity-priority-rubric.md)** - Reference for severity and priority classification
