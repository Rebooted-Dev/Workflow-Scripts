...
## Purpose
Perform a structured code review that identifies defects, risks, and refactoring opportunities, then file a report in `<metadata-root>/research/` using the metadata-root rule in `../../core/meta/naming-conventions.md`.
...
Follow `../../core/meta/review-workflow-core.md`; code-review-specific checks are:
...
## Prioritization Rule
Use `../../core/meta/review-workflow-core.md` and the shared rubric at `../../core/meta/severity-priority-rubric.md`.
...
3. **Group, deduplicate, and order findings using `../../core/meta/review-workflow-core.md`:**
...
- **[`../security/01-security-review.md`](../security/01-security-review.md)** - Dedicated security audit
...
- **[`../planning/02-finalise-plan.md`](../planning/02-finalise-plan.md)** - Create implementation plan for review findings
