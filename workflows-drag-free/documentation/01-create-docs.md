...
#### Generated Reports
When workflows generate reports or analysis documents, follow the naming convention defined in [`../../core/meta/naming-conventions.md`](../../core/meta/naming-conventions.md).
...
- **[`../build/01-execution.md`](../build/01-execution.md)** - Update documentation after code changes
