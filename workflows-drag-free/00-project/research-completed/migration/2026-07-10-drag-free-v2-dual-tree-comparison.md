...
related:
  ...
  - workflows-drag-free/00-project/changelog/plans/2026-07-06-drag-free-v2-unified-implementation-plan.md
...
`plans-completed/migration/` now holds the 2026-07-10 reconciliation and ops-meta migration plans. This comparison and the problem statement are filed under `research-completed/migration/`.
...
| Artifact | Path |
|----------|------|
| Prior problem statement | `workflows-drag-free/00-project/research-completed/migration/2026-07-07-drag-free-v2-migration-problem-statement.md` (canonical; live ops path is a `# Moved` pointer) |
...
**Complete (investigation) — filed 2026-07-10.**

- **Active consolidation target:** `workflows-drag-free/`  
- **Second tree:** `00-project/Drag-Free-v2/` retired (tarball under ops `build/archive/`)
- **Plans filed:** `plans-completed/migration/` (single-master + ops-meta migration)
- **Deferred:** skills placement (Phase 7 of single-master plan)
