...
This contradicts the 2026-07-06 research decision in `workflows-drag-free/00-project/research-completed/migration/2026-07-06-legacy-meta-workflow-migration-decision.md`, which states that every `00-Meta-Workflow/` row has an existing canonical target with content.
...
| Meta migration decision | `workflows-drag-free/00-project/research-completed/migration/2026-07-06-legacy-meta-workflow-migration-decision.md` |
...
**Resolved (2026-07-10)** — Redirect repair, numbered `workflows-drag-free/` layout, and second-tree retirement completed on branch `fix/v2.0a-separate-legacy-and-v2`. Validators: `146/146` `MOVED` targets, `tools/wf validate` clean.

**Superseded by:**

- `../plans-completed/migration/2026-07-10-single-master-directory-reconciliation-plan.md`
- `../research-completed/migration/2026-07-10-drag-free-v2-dual-tree-comparison.md` (answers open question #1: WDF was the intended active library)

Open questions #2–#5 remain historical context; no blocking follow-up on the remediation branch.
