...
**Implementation status (2026-07-06):** Baseline survey. Drag-Free-v2 Phase 2 implemented KI-10/KI-11 (core partials, duplication linter, `core/roles/` registry, pilot workflow token reduction). Median reduction 30.5% on pilot files (below 40%/55% target). Some workflows retain free-text spawn menus.
