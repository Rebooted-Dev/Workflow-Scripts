...
2. Research and architecture
   - Use `../01-planning/00-research-and-plan.md` for research.
...
3. Walking skeleton
   ...
   - Deploy the near-empty app to the real target environment using `../07-deployment/00-deploy.md` when present or the project deployment guide.
4. Feature slices
