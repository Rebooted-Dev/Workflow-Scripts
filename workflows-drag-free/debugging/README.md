...
- [Code Build](../build/01-execution.md) - Implement the fix
- [Confirm Execution](../build/02-confirm-execution.md) - Verify the fix
- [Code Review](../review/01-code-review.md) - Review the fix
- [Sync Documentation](../documentation/02-sync-documentation.md) - Update docs with bug info
