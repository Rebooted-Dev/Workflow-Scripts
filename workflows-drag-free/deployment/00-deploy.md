...
- Security baseline checks from `../../core/standards/security-baseline.md` are complete or explicitly deferred with a debt entry.
...
- Operators know where to find logs and error signals per `../../core/standards/observability.md`.
