...
- **[`../02-build/01-execution.md`](../02-build/01-execution.md)** - Execute plans after they've been reviewed
- **[`../05-review/01-code-review.md`](../05-review/01-code-review.md)** - Review code after implementation
- **[`../00-core/meta/severity-priority-rubric.md`](../00-core/meta/severity-priority-rubric.md)** - Reference for scoring issues
