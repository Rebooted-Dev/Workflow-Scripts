...
- Pair with **[`../../../debugging/02-bug-fix-workflow.md`](../../../debugging/02-bug-fix-workflow.md)** when the root cause is a code defect, not stale OAuth.
...
1. Follow **[`../../../debugging/02-bug-fix-workflow.md`](../../../debugging/02-bug-fix-workflow.md)**.
...
- **[`../../../debugging/02-bug-fix-workflow.md`](../../../debugging/02-bug-fix-workflow.md)** — code defects in preflight/reconnect/guards
- **[`../../../debugging/01-bug-description.md`](../../../debugging/01-bug-description.md)** — structured report for persistent auth issues
- **[`../../../planning/00-research-and-plan.md`](../../../planning/00-research-and-plan.md)** — auth recovery implementation planning
- **[`../../../documentation/02-sync-documentation.md`](../../../documentation/02-sync-documentation.md)** — sync `docs/configuration/README.md` after runbook changes
