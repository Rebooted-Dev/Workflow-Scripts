...
- Keep the five existing files in `00-project/plans/Drag-Free-v2/` as source evidence.
...
- Phase 0 was reconciled and finalised:
  ...
  - source proposals and surveys remain available under `00-project/plans/Drag-Free-v2/research-papers/`;
